...
export default function Step3() {
  ...
  const { design_parameters: dp, setDesignParameters, confirmStep3, step3_confirmed } = useProjectStore()
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="step-header">
        ...
        <p className="step-subtitle">Configure design parameters for this project.</p>
      </div>
